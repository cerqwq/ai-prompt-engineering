"""
AI Prompt Engineering - AI提示工程工具
支持提示设计、优化、测试
"""
...
class AIPromptEngineeringTools:
    """
    AI提示工程工具
    支持：设计、优化、测试
    """
...
def create_tools(**kwargs) -> AIPromptEngineeringTools:
    """创建提示工程工具"""
    return AIPromptEngineeringTools(**kwargs)


if __name__ == "__main__":
    tools = create_tools()

    print("AI Prompt Engineering Tools")
    print()

    # 测试
    prompt = tools.design_prompt("代码审查", ["简洁", "专业", "包含建议"])
